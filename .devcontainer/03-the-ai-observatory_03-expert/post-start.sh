...
CHALLENGE_DIR="$REPO_ROOT/adventures/03-the-ai-observatory/expert"

echo "✨ Starting The AI Observatory - Expert Level"
...
set_tracking_context "the-ai-observatory" "expert" "03" "02" "2026"
